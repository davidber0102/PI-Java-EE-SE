...
<body>
	<h2> Fomrularo</h2>
	<h3> <strong>Actualizar Registro</strong></h3>
  ...
  <table width="100%" border="3">
    ...
    <tr>
      ...
      <td><label for="nomArt"></label>
        <input type="text" name="nomArt" id="nomArt" value="${ProductoActualizar.nArt}"/></td>
    </tr>
    <tr>
      <td>Precio Articulo</td>
      <td><label for="precioArt"></label>
        <input type="text" name="precioArt" id="precioArt" value="${ProductoActualizar.precio}" /></td>
    </tr>
    <tr>
      <td>Fecha</td>
